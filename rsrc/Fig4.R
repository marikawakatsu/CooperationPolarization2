...
# Plotting functions
#####################################
plot_figSa <- function(simdata_dist, tag = "A", colors = cityblock_colors){
  ...
  figSa <- ggplot(data = subdata, 
    ...
    theme(legend.text  = element_text (size = 7),
          ...
          panel.spacing = unit(0.2/3,  "lines"),
          # legend.margin = margin(t = 0, unit="npc"),
          # axis.text.y = element_text(size=12)
          title = element_text(size = 18)
    ) +
...
plot_figSb <- function(simdata_dist, tag = "B", colors = hamming_colors){
...
plot_figSa_unnormed <- function(simdata_dist, tag = "A", colors = cityblock_colors){
...
plot_figSb_unnormed <- function(simdata_dist, tag = "B", colors = hamming_colors){
...
###########################################
figSa <- plot_figSa(simdata_dist, "A")
figSb <- plot_figSb(simdata_dist, "B")

if(saveplots == 1){
  
  plottype <- paste0("figSC_normed")
...
###########################################
figSa_unnormed <- plot_figSa_unnormed(simdata_dist, "A")
figSb_unnormed <- plot_figSb_unnormed(simdata_dist, "B")
